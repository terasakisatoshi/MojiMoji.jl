...
COPY ./src /workspace/MojiMoji.jl/src
COPY ./docs/Project.toml /workspace/MojiMoji.jl/docs
COPY ./Project.toml /workspace/MojiMoji.jl

USER root
RUN chown -R ${NB_UID} /workspace/MojiMoji.jl
USER ${USER}
